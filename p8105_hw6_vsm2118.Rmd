...
```
********ADD DESCRIPTION OF MODEL BUILDING PROCESS AND FINAL MODEL**********
The final model...
...
In summary, the initial model, which uses the predictors selected through the stepwise model building process, appears to provide the best average cross-validated prediction performance among the three models. Model 2, with additional predictors and interactions, performs better than Model 1 but not as well as the initial model. This comparison underscores the importance of considering the trade-off between model complexity and predictive accuracy.
